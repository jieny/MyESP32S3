...
// 定义 HTML 内容为 String 类型
    String html_str = "<html><body><h1>Custom WiFi Config</h1></body></html>";

    // 直接将 String 赋值给 wifi_config.html_str
    wifi_config.html_str = html_str; // String 类型的赋值
